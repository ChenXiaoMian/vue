<style lang="less" scoped>
  ...
  .user{
    position: relative;
    height: 180px;
    background: url(../../assets/headimg-bg.jpg) no-repeat center center;
...
<template>
  <div>
    <v-header title="个人中心">
      <div slot="right" class="item" flex="main:center cross:center"  v-on:click="$router.push('/signout')">
    ...
    <v-content class="con">
      ...
      <nav class="nav">
        ...
        <li>
          <router-link to="/home/message" flex="box:justify">
            <div class="icon" flex="cross:center">
